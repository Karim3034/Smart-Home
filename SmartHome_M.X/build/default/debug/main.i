...
RTC_t rtc_obj;
char*res;
uint8_t temp_value=0,eevalue=0;
...
# 78 "main.c"
    ...
    while (1)
    {
        lcd_4bit_send_command(&lcd_obj, 0X01);
        ...
        lcd_4bit_send_char_data(&lcd_obj,(temp_value/10)+'0');
        lcd_4bit_send_char_data(&lcd_obj,(temp_value%10)+'0');
