...
# 816 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
  ...
  if (*cp == 'n') {
   ...
   switch (c) {
     ...
     *(*(int* *)__va_arg(*(int* **)ap, (int*)0)) = (int) nout;
     break;
# 1365 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     ...
     *(*(ptrdiff_t* *)__va_arg(*(ptrdiff_t* **)ap, (ptrdiff_t*)0)) = (ptrdiff_t) nout;
     break;
# 1389 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\sources\\c99\\common\\doprnt.c"
   }
